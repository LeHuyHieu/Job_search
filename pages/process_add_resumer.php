...
if (isset($_POST['edit_education'])) {
    ...
    if (isset($_POST['education_id'])) {
        ...
        $sql = "UPDATE education SET education_school = '$education_school', education_level = '$education_level', start_education_date = '$start_education_date', end_education_date = '$end_education_date' where id = '$education_id'";
    } else {
        $user_id = $_POST['user_id'];
        $_SESSION['user']['education_id'] = $user_id;
        $sql = "INSERT INTO education (user_id, education_school, education_level, start_education_date, end_education_date, created_at, updated_at) VALUES ('$user_id' , '$education_school', '$education_level', '$start_education_date', '$end_education_date', NOW(), NOW())";
    }
...
if (isset($_POST['save_experience'])) {
    ...
    if (isset($_POST['experience_id'])) {
        ...
        $sql = "UPDATE experience SET experience_employer = '$experience_employer', experience_job = '$experience_job', start_experience_date = '$start_experience_date', end_experience_date = '$start_experience_date' where id = '$experience_id'";
    } else {
        $user_id = $_SESSION['user']['id'];
        $_SESSION['user']['experience_id'] = $user_id;
        $sql = "INSERT INTO experience (user_id, experience_employer, experience_job, start_experience_date, end_experience_date, created_at, updated_at) VALUES ('$user_id' , '$experience_employer', '$experience_job', '$start_experience_date','$end_experience_date', NOW(), NOW())";
    }
    if ($conn->query($sql) === true) {
