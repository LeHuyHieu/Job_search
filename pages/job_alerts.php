            ...
            <div class="left__position">
                <div class="left__block">
                    ...
                    <ul class="list__profile">
                        ...
                        <li class="item__profile"><a href="/pages/job_alerts.php" class="link__profile color__green"><i class="fas fa-bell"></i> Job Alerts <span class="notification">1</span></a></li>
