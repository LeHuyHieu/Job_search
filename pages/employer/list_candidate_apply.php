        ...
        <div class="right mh-100">
            <div class="container-fluid">
                <div class="row p-5">
                    ...
                    <p class="link__home"><a href="/index.php">Trang chủ <i class="fas fa-angle-right"></i> </a>Danh sách ứng tuyển</p>
                    <a href="./list_candidate_hidden.php" class="btn btn-primary mb-3">Danh sách ứng viên đã ẩn</a>
                    <div class="profile_details bookmark_detail bg-white p-0">
                        <?php
                        $user_id = $_SESSION['user']['id'];
                        $sql = "SELECT alert_job.*, jobs.title, jobs.id as id_job, jobs.category_id, jobs.images, users.id AS id_user, users.name FROM alert_job LEFT JOIN jobs ON jobs.id = alert_job.job_id LEFT JOIN users ON users.id = alert_job.user_id WHERE alert_job.employer = '$user_id' AND hidden = 0 ORDER BY id DESC";
                            ...
                            <tbody>
                                <?php foreach ($alert_jobs as $alert_job) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="./hidden_candidate.php?hidden=<?php echo 1; ?>&id=<?php echo $alert_job['id']; ?>" class="btn btn-secondary mb-3 text-white"><i class="fas fa-eye-slash"></i> Ẩn</a> <br>
                        ...
                        <div class="d-flex align-items-center pt-5">
                            <a href="./submit_job.php" class="btn btn--all ms-3 my-3">Thêm mới công việc</a>
                            <div class="flex__right">
                                <a class="btn btn--pages ms-3 px-3" href=""><i class="fa-solid fa-circle-chevron-left"></i> Prev</a>
                                <a class="btn btn--page ms-3 px-3" href="">1</a>
                                <a class="btn btn--page active ms-3 px-3" href="">2</a>
                                <a class="btn btn--page ms-3 px-3" href="">3</a>
                                <a class="btn btn--pages ms-3 px-3 me-4" href="">Next <i class="fa-solid fa-circle-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
