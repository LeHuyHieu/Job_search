                ...
                <?php if ($_SESSION['user']['employer'] == 1) { ?>
                    <div class="left__block">
                        ...
                        <ul class="list__profile">
                            ...
                            <li class="item__profile"><a href="/pages/employer/add_company.php" class="link__profile color__green"><i class="fa-solid fa-square-plus"></i> Add Company <span class="notification">1</span></a></li>
                        </ul>
                    </div>
                <?php } ?>
                <div class="left__block">
